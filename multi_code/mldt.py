...
#
#
# result,result1,result2 = MLDecisionTree(min_num=10).fit(x_train, y_train).predict(x_test)
# c = 0
# y_test2 = []
...
result,result1,result2 = MLDecisionTree(min_num=40).fit(x_train, y_train).predict(x_test)
scio.savemat("mldt_result.mat",{'result':result})
